...
# edited for sensitivity analysis and remote solve
...
for kr0 in [1e4,1e5,1e6]:
    for kr1 in [0.5, 0.1, 0.2, 0.3]:
        for kr5 in [10.0, 100.0]:
            for lnrm in [1, 2]:
                try:
                    ...
                    # Define Parameters
                    kr_init = [kr0, kr1, 2e-7, 0.5, 5.0, kr5]
                    ...
                    m.options.EV_TYPE = lnrm       # l2 norm
